...
$(function () {
    ...
    $("#addItemForm").submit(function (e) {
        ...
        files = $("#ProductFile").val()

        let subCat = newCatArray[subCategory];

        firebase.auth().onAuthStateChanged((user) => {
            if (user) {
                db.collection("category").doc(subCat).set({
                    title: title,
        ...
        console.log("this is the subcategory" + newCatArray[subCategory] + "and this is the subsection " + subSection +
            " this is the title " + title + " and short description " + shortDescription + " also long description " + longDescription +
            "the price " + price + "and promo price " + promoPrice + "and file " + files);
